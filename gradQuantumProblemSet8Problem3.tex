...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:20}
H =
\frac{p_x^2}{2m}
+\frac{p_y^2}{2m}
+ \inv{2} m \omega^2 \lr{ x^2 + y^2 },
\end{equation}
and turn on an anharmonic perturbation
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:40}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:60}
...
%
or
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:200}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:220}
\begin{aligned}
\bra{n^{(0)}} H -H_0 \ket{n}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:240}
\Delta \braket{n^{(0)}}{n} = \bra{n^{(0)}} { V_1 \Delta^{(1)} + V_2 \Delta^{(2)} } \ket{n}.
\end{equation}
%
Expanding both sides in powers of \( \lambda \) we have
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:260}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:320}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:480}
\begin{aligned}
V_1 \ket{0,0}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:520}
\Delta^{(1)} = \bra{0,0} V_1 \ket{0,0} = \frac{3}{2} g_1 \Hbar \omega,
\end{equation}
%
and the first order perturbation of the state is
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:540}
\begin{aligned}
...
%
or
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:560}
\ket{n_1} = -g_1
\lr{
...
%
We can calculate
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:580}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:600}
\Delta^{(2)} = -\frac{21}{4} \Hbar \omega g_1^2.
\end{equation}
%
Finally, the ground state energy shift, to second order in \( \lambda \), is
%
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem3:640}
\begin{aligned}
