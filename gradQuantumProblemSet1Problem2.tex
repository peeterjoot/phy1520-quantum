...
%
\makeoproblem{Reduced density matrix.}{gradQuantum:problemSet1:2}{2015 ps1.2}{
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:20}
\rho_\txtR
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:40}
\begin{aligned}
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:60}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:80}
\begin{aligned}
\rho_\txtR
&=
\inv{4}
...
so the reduced density operator matrix representation is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:140}
\begin{aligned}
\rho_\txtR
&=
\inv{2}
...
so the reduced density operator matrix representation is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:200}
\begin{aligned}
\rho_\txtR
&=
\inv{5}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:220}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:240}
S_{\txtv \txtN} = 2 \lr{ - \inv{2} \ln \inv{2} } = \ln 2 \approx 0.69.
\end{equation}

\item This is also diagonal with von Neumann entropy of
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:260}
\begin{aligned}
S_{\txtv \txtN}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:340}
S_{n=2} = -\ln \lr{ \inv{2^2} + \inv{2^2}} = \ln 2 \approx 0.69.
\end{equation}
%
\item Finally, for this case, the \( n = 2 \) Renyi entropy is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:360}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:380}
S_{n \rightarrow 1}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:400}
\begin{aligned}
S_{n \rightarrow 1}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:420}
\begin{aligned}
\frac{d}{dn} a^n
&=
\frac{d}{dn} e^{ n \ln a }
...
which gives
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem2:440}
\begin{aligned}
S_{n \rightarrow 1}
&=
-
