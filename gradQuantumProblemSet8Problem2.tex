...
It has eigenvalues
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem2:120}
\lambda \int_0^\infty r^4 dr R^2_n(r)
\setlr{
 -\frac{2}{5},
 \frac{2}{5},
...
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem2:140}
\setlr{
\inv{\sqrt{2}}
\begin{bmatrix}
1 \\
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem2:160}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem2:180}
...
In this basis that level splitting is
\begin{equation*}
\lambda \int_0^\infty r^4 dr R^2_n(r) \setlr{ \frac{2}{5}, -\frac{2}{5}, 0 },
\end{equation*}
respectively.
}
}
