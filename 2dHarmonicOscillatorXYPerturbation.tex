...
\end{equation}
%
So the three lowest energy states are \( \ket{0,0}, \ket{1,0}, \ket{0,1} \) with energies
\begin{equation*}
\Hbar \omega, 2 \Hbar \omega, 2 \Hbar \omega,
\end{equation*}
respectively (with a two fold degeneracy for the second two energy eigenkets.)
%
