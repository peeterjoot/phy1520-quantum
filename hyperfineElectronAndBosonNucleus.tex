...
%
\begin{equation}\label{eqn:hyperfineElectronAndBosonNucleus:100}
\begin{aligned}
\ket{\ncap; +} &=
\begin{bmatrix}
\cos(\theta/2) e^{-i\phi} \\
...
\begin{equation}\label{eqn:hyperfineElectronAndBosonNucleus:120}
\begin{aligned}
S_e^z \ket{\ncap;+}
&=
\frac{\Hbar}{2} \lr{
...
%
and
\begin{equation}\label{eqn:hyperfineElectronAndBosonNucleus:140}
\begin{aligned}
S_e^z \ket{\ncap;-}
&=
\frac{\Hbar}{2} \lr{
...
\begin{equation}\label{eqn:hyperfineElectronAndBosonNucleus:320}
E \approx
\left\{
\begin{array}{l l}
