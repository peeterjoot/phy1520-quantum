...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:20}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:40}
...
%What are the spin eigenstates and eigenvalues?
With respect to the basis \( \beta = \ket{++}, \ket{-+}, \ket{+-}, \ket{--} \), where \( \ket{\pm, \pm} = \ket{\pm}_\txte \otimes \ket{\pm}_\txtp \) are the direct products of the eigenkets of the \( \BS_\txte \) and \( \BS_\txtp \) operators (not of the respective \( S^z \) operators), we can compute the unperturbed interaction Hamiltonian.  For brevity, let \( S_{\txte\txtp} = \BS_\txte \cdot \BS_\txtp \)
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:60}
A  \BS_\txte \cdot \BS_\txtp 
=
A
\begin{bmatrix}
\bra{++} S_{\txte\txtp} \ket{++} & \bra{++} S_{\txte\txtp} \ket{-+} & \bra{++} S_{\txte\txtp} \ket{+-} & \bra{++} S_{\txte\txtp} \ket{--} \\
\bra{-+} S_{\txte\txtp} \ket{++} & \bra{-+} S_{\txte\txtp} \ket{-+} & \bra{-+} S_{\txte\txtp} \ket{+-} & \bra{-+} S_{\txte\txtp} \ket{--} \\
\bra{+-} S_{\txte\txtp} \ket{++} & \bra{+-} S_{\txte\txtp} \ket{-+} & \bra{+-} S_{\txte\txtp} \ket{+-} & \bra{+-} S_{\txte\txtp} \ket{--} \\
\bra{--} S_{\txte\txtp} \ket{++} & \bra{--} S_{\txte\txtp} \ket{-+} & \bra{--} S_{\txte\txtp} \ket{+-} & \bra{--} S_{\txte\txtp} \ket{--} \\
\end{bmatrix}.
\end{equation}
Each of the matrix elements may be expanded in terms of the Pauli basis, for example
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:n}
\begin{aligned}
\bra{++} S_{\txte\txtp} \ket{-+} 
&=
\frac{\Hbar^2}{4}
\bra{+} \sigma_\txte \ket{-} \bra{+} \sigma_\txtp \ket{+} 
\\ &=
\frac{\Hbar^2}{4}
\braket{+}{-} \braket{+}{+},
\end{aligned}
\end{equation}
so
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:61}
\begin{aligned}
A \BS_\txte \cdot \BS_\txtp 
&=
\frac{A \Hbar^2}{4}
...
%\end{bmatrix}
\begin{bmatrix}
\braket{+}{+} \braket{+}{+} & \braket{+}{-} \braket{+}{+} & \braket{+}{+} \braket{+}{-} & \braket{+}{-} \braket{+}{-} \\
\braket{-}{+} \braket{+}{+} & \braket{-}{-} \braket{+}{+} & \braket{-}{+} \braket{+}{-} & \braket{-}{-} \braket{+}{-} \\
\braket{+}{+} \braket{-}{+} & \braket{+}{-} \braket{-}{+} & \braket{+}{+} \braket{-}{-} & \braket{+}{-} \braket{-}{-} \\
\braket{-}{+} \braket{-}{+} & \braket{-}{-} \braket{-}{+} & \braket{-}{+} \braket{-}{-} & \braket{-}{-} \braket{-}{-} \\
\end{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:80}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:100}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:120}
\ket{+} =
\begin{bmatrix}
e^{-i\phi} \cos(\theta/2) \\
\sin(\theta/2) \\
\end{bmatrix},
\end{equation}
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:140}
\ket{-} =
\begin{bmatrix}
-e^{-i\phi} \sin(\theta/2) \\
\cos(\theta/2) \\
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:160}
\begin{aligned}
\sigma^z_\txte
&=
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:200}
H
=
\frac{A \Hbar^2}{4}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet8Problem4:220}
H' =
\frac{A \Hbar^2}{4}
\begin{bmatrix}
U^{-1} \sigma_z U & 0 \\
...
See
\nbref{ps8:PauliMatrixSpinOperators.nb}
for the full field solutions, which are
