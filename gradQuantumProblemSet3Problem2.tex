...
%
\makeoproblem{Landau Levels - Symmetric gauge.}{gradQuantum:problemSet3:2}{2015 ps3.2}
{
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:20}
...
Writing
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:100}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:220}
E_n = \Hbar \omega \lr{ n + \inv{2} }.
\end{equation}
%
For the symmetric gauge where \( A_x = - B_0 y/2, A_y = B_0 x/2 \), the lowering operator has the form
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:240}
\begin{aligned}
b
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:280}
\begin{aligned}
0
&=
\bra{x,y} b \ket{0}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:300}
u_n(x,y) = c_n \lr{ x + i y }^n e^{-\alpha \lr{x^2 + y^2}/2},
\end{equation}
%
which can be verified directly
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:320}
\begin{aligned}
...
&=
c_n e^{-\alpha \lr{x^2 + y^2}/2} 
\biglr{
n \lr{ x + i y }^{n-1} \lr{ 1 + i^2 } \times \\
&\qquad -\alpha \lr{ x + i y }^n \lr{ 2x + 2 y i }/2 + \alpha \lr{ x + i y }^{n+1}
} \\
&= 0.
\end{aligned}
\end{equation}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:340}
\begin{aligned}
1
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:360}
\begin{aligned}
1
...
so
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:380}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:420}
\begin{aligned}
0
&=
\frac{d}{dr} \lr{
...
which occurs at
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:440}
\begin{aligned}
r^2
&= \frac{(2 n + 1)}{2 \alpha}
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem2:480}
\begin{aligned}
n
