...
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:20}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:260}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:60}
\begin{aligned}
\hatJ_y^2
&=
-\frac{\Hbar^2}{2}
...
%
and the cube is
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:80}
\begin{aligned}
\hatJ_y^3
&=
-\frac{\Hbar^2}{2}
...
%
In particular
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:220}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem3:120}
\begin{aligned}
