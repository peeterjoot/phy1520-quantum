...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:80}
\begin{aligned}
&\bra{n} x(0) x(0) \ket{n} \\
&=
...
%
and
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:100}
\begin{aligned}
&\bra{n} x(0) p(0) \ket{n} \\
&=
\frac{i \Hbar}{2}
...
\end{equation}
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:101}
\begin{aligned}
\bra{n} p(0) p(0) \ket{n}
&=
\frac{-\Hbar^2 }{ 2 x_0^2}
...
and finally
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:120}
\begin{aligned}
\bra{n} p(0) x(0) \ket{n}
&=
\bra{n}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:140}
\begin{aligned}
\bra{n} x(0) x(t) \ket{n}
&=
\bra{n} x(0) \lr{
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem3:200}
\begin{aligned}
\bra{n} p(0) p(t) \ket{n}
&=
\bra{n} p(0) \lr{
