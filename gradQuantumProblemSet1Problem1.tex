...
%
\makeoproblem{Density matrix.}{gradQuantum:problemSet1:1}{2015 ps1.1}{
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:20}
\ket{\psi} =
\begin{bmatrix}
1 \\
0
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:40}
\hat\rho
=
\begin{bmatrix}
1 \\
...
This state in matrix form is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:60}
\ket{\psi} =
\inv{\sqrt{2}}
\lr{
\begin{bmatrix}
...
for which the density operator representation is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:80}
\hat\rho
=
\inv{2}
\begin{bmatrix}
...
This state in matrix form is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:100}
\ket{\psi} =
\inv{\sqrt{2}}
\lr{
\begin{bmatrix}
...
for which the density operator representation is
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:120}
\hat\rho
=
\inv{2}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:140}
\begin{aligned}
U(t)
&= e^{-i \hatH t/\Hbar}
\\ &= e^{i B S_z t/\Hbar}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:160}
\begin{aligned}
\ket{\psi(t)} &=
\inv{\sqrt{2}}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet1Problem1:180}
\begin{aligned}
\hat\rho(t)
&=
\inv{2}
