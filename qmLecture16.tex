...
That is
%
\begin{equation}\label{eqn:qmLecture16:340}
\begin{aligned}
\bra{\psi} \lr{ \Lcap_1 + \Lcap_2 }^2 \ket{\psi}
&<
\Hbar^2
...
\end{equation}
or
\begin{equation}\label{eqn:qmLecture16:380}
...
which, gives
%
\begin{equation}\label{eqn:qmLecture16:400}
...
%
\begin{equation}\label{eqn:qmLecture16:440}
\begin{aligned}
\bra{\psi} \lr{ \Lcap_1 + \Lcap_2 }^2 \ket{\psi}
&>
\Hbar^2
...
%
\begin{equation}\label{eqn:qmLecture16:480}
l_{\textrm{tot}}( l_{\textrm{tot}} + 1 ) >
\lr{ l_1 - l_2 -\inv{2} } \lr{ l_1 - l_2 +\inv{2} } - \inv{4}.
\end{equation}
Is it true that
%
\begin{equation}\label{eqn:qmLecture16:500}
l_{\textrm{tot}}( l_{\textrm{tot}} + 1 ) >
...
%
\begin{equation}\label{eqn:qmLecture16:520}
\begin{aligned}
l_{\textrm{tot}}( l_{\textrm{tot}} + 1 )
&= \lr{ l_1 - l_2 -\inv{2} } \lr{ l_1 - l_2 +\inv{2} }
\\ &= \lr{ l_1 - l_2 }^2 - \inv{4}.
...
%
\begin{equation}\label{eqn:qmLecture16:600}
2 \sqrt{ x y } \ge x + y + \inv{4},
\end{equation}
%
or
\begin{equation}\label{eqn:qmLecture16:620}
4 x y \ge (x + y)^2 + \inv{16} + \inv{2}(x + y),
\end{equation}
%
or
\begin{equation}\label{eqn:qmLecture16:700}
...
%
\begin{equation}\label{eqn:qmLecture16:680}
\begin{aligned}
