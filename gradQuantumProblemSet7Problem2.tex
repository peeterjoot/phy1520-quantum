...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:20}
H
=
...
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:40}
\psi(\Br_1, \Br_2)
=
N
e^{- \inv{a} \lr{ r_1 + r_2 } }.
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:660}
\psi(r_1, r_2) = \psi_1(r_1) \psi_2(r_2),
\end{equation}
%
The Hamiltonian action on this wave function is
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:680}
\begin{aligned}
...
%
or
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:700}
\begin{aligned}
E
&=
...
+
\Biglr{\inv{\psi_2(r)} \lr{ \inv{2m} \Bp_2^2 \psi_2(r_2) } \\
&\quad
-
2 e^2
...
%
where
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:880}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:340}
\begin{aligned}
\spacegrad^2 e^{-r/a}
&=
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:120}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:140}
\begin{aligned}
H \psi(r_1, r_2)
&=
\frac{\Bp_1^2}{2m} \psi
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:260}
E_{\textrm{He}}
%=
%\frac{
%   \bra{ \psi }
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:180}
%\begin{aligned}
%\braket{ \psi }{ \psi }
%&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:200}
%\bra{ \psi } \inv{r} \ket{ \psi }
%=
...
%%%
%%%\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:620}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:280}
%\begin{aligned}
\braket{ \psi }{ \psi }
=
\lr{ 4 \pi}^2
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:300}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:320}
\begin{aligned}
E_{\textrm{He}}
&=
   \lr{ \frac{\Hbar^2}{m a} - e^2 \inv{2 \pi \epsilon_0 } }
...
%%%
%%%\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:640}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:900}
\inv{\Abs{\Br}}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:420}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:440}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:460}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:480}
\begin{aligned}
\frac{e^2}{4 \pi \epsilon_0} \bra{\psi} \inv{\Abs{\Br_1 - \Br_2}} \ket{\psi}
&=
\frac{e^2}{4 \pi \epsilon_0}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:500}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:520}
E_{\textrm{He}}
=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:540}
\begin{aligned}
0
&=
\PD{a}{E}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:560}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem2:860}
E_{\textrm{He}}
=
