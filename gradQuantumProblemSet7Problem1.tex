...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:20}
V (x) =
...
Hence determine the `tunnel splitting' between the two states, induced by the tunnelling through
the barrier region.
...
\end{equation}
%
where \( \epsilon_0 \) is the energy on each side, and \( \gamma \) leads to tunnelling, so if we start off in the left well, \( t \) leads to a nonzero amplitude to find it in the right well at a later time.
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:100}
\begin{aligned}
\coth u -1
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:120}
\overbar{E}_{+} - \overbar{E}_{-}
\approx
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:140}
0 = \lr{ \epsilon_0 - E }^2 - \gamma^2,
\end{equation}
%
with eigenvalues
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:160}
E_{\pm} = \epsilon_0 \pm \gamma.
\end{equation}
%
If the eigenvectors are proportional to the column vector given by
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:180}
\ket{\pm} =
\begin{bmatrix}
a \\
b
...
then we must have
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:200}
\begin{aligned}
0
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:220}
\ket{\pm}
=
\inv{\sqrt{2}}
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:240}
\begin{aligned}
\Delta E
&= E_{+} - E_{-}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem1:260}
\gamma
=
