...
%
%
\makeoproblem{Coherent States.}{gradQuantum:problemSet2:1}{2015 ps2.1, and \citep{sakurai2014modern} pr. 2.19(c)}{
...
Using the Heisenberg picture, compute the time evolution of
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:741}
\expectation{x(t)}, \expectation{p(t)}, \expectation{x^2(t)},
\end{equation}
and \( \expectation{p^2(t)} \) in the coherent state \( \ket{z} \).  Comment on connections to classical dynamics of the oscillator in phase space.
%
...
Let
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:20}
\ket{z} = \sum_{n=0}^\infty c_n \ket{n},
\end{equation}
%
The defining identity for \( \ket{z} \) becomes
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:40}
\begin{aligned}
a \ket{z}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:60}
c_{n} = \frac{c_{n-1} z}{\sqrt{n}},
\end{equation}
%
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:80}
\begin{aligned}
...
or
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:120}
\begin{aligned}
\ket{z}
&= c_0
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:140}
\begin{aligned}
\ket{n}
...
so that
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:160}
\begin{aligned}
\ket{z}
&= c_0
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:200}
\begin{aligned}
\braket{z}{z}
&=
\Abs{c_0}^2
...
or
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:240}
\ket{z} = e^{-\Abs{z}^2/2 + a^\dagger z} \ket{0}.
\end{equation}
%
\makeSubAnswer{}{gradQuantum:problemSet2:1b}
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:260}
\begin{aligned}
\braket{z}{z'}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:280}
\braket{z}{z'} =
...
First note that
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:300}
\begin{aligned}
\bra{z} a^\dagger
&=
\lr{a \ket{z}}^\dagger
...
so
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:320}
\begin{aligned}
\expectation{x}
&=
...
\end{equation}
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:340}
\begin{aligned}
\expectation{p}
&=
...
\end{equation}
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:360}
\begin{aligned}
\expectation{x^2}
&=
...
%
and
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:380}
\begin{aligned}
\expectation{p^2}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:400}
\begin{aligned}
...
%
and
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:420}
\begin{aligned}
...
%
so we have
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:440}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:501}
\begin{aligned}
\bra{\psi} A(t) \ket{\psi'}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:521}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:460}
\begin{aligned}
\expectation{x(t)}
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:480}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:541}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem1:481}
\begin{aligned}
