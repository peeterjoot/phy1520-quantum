...
%
where
\begin{equation}\label{eqn:harmonicOscDiagonalize:400}
\begin{aligned}
...
%
The raising and lowering operators are seen to naturally occur when seeking the solution of the Heisenberg equations of motion.
We non-dimensionalize and seeking a change of basis that diagonalizes the system matrix.
