...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:20}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:40}
\begin{aligned}
\Theta (J_m n_m)^k
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:60}
\Theta \calD(R) \ket{j, m}
=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:80}
\Theta J_i = - J_i \Theta.
\end{equation}
%
Considering each of \( J_z \) and \( J_{\pm} \) in turn, we first have
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:100}
\begin{aligned}
\Theta J_z \ket{j, m}
&=
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:120}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:140}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:160}
\begin{aligned}
\Theta J_{+} \Theta^{-1}
&=
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:180}
\begin{aligned}
\Theta J_{-} \Theta^{-1}
&=
\Theta \lr{ J_x - i J_y } \Theta^{-1}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:220}
\begin{aligned}
J_{+} \Theta \ket{j, m}
&=
J_{+} c_m \ket{j, -m}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:240}
\begin{aligned}
J_{+} \Theta \ket{j, m}
&=
-\Theta J_{-} \ket{j, m}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:260}
c_m = - c_{m-1} = (-1)^k c_{m-k}.
\end{equation}
In particular for \( m -k = -j \), this is
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:280}
c_m = (-1)^{m + j} c_{-j}.
\end{equation}
%
Acting twice with the time reversal operator
%
\begin{equation}\label{eqn:gradQuantumProblemSet5Problem4:300}
\begin{aligned}
\Theta^2 \ket{j, m}
&=
