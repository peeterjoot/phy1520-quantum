...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:20}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:200}
\begin{aligned}
e^{-i \sigma_z \mu/2}
&=
...
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:220}
\begin{aligned}
e^{-i \sigma_y \beta/2}
&=
...
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:240}
\begin{aligned}
\calD^{1/2}(\alpha, \beta, \gamma)
&=
\begin{bmatrix}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:40}
\begin{aligned}
\calR
&= e^{-i \Bsigma \cdot \ncap \theta/2}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:60}
\begin{aligned}
\Bsigma \cdot \ncap
&=
\begin{bmatrix}
...
so
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:80}
\calR =
\begin{bmatrix}
...
That is
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:100}
\begin{aligned}
\calD^{1/2}(\alpha, \beta, \gamma)
&=
\begin{bmatrix}
...
The angle is
%
\begin{equation}\label{eqn:gradQuantumProblemSet6Problem1:140}
\theta
= 2 \Atan \frac{
