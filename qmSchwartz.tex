...
\end{equation}
%
This is similar to, but not identical to the Schwartz inequality.
The Schwartz inequality cannot be demonstrated with this argument, since \( \Abs{\Real \braket{a}{b}} \le \Abs{\braket{a}{b}} \).
This first year algebra method works nicely for demonstrating the inequality for real vector spaces, so a different argument is required for a complex vector space (i.e. quantum mechanics state space.)
