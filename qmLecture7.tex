...
\imageFigure{../figures/phy1520-quantum/lecture7Fig1}{Two slit interference with magnetic whisker.}{fig:lecture7:lecture7Fig1}{0.2}
...
\imageFigure{../figures/phy1520-quantum/lecture7Fig3}{Circular trajectory.}{fig:lecture7:lecture7Fig3}{0.1}
...
\imageFigure{../figures/phy1520-quantum/lecture7Fig4}{Superconductivity with comparison to superfluidity.}{fig:lecture7:lecture7Fig4}{0.2}
...
\imageFigure{../figures/phy1520-quantum/lecture7Fig6}{Little-Parks superconducting ring.}{fig:lecture7:lecture7Fig6}{0.1}
...
%\imageFigure{../figures/phy1520-quantum/lecture7Fig7}{CAPTION: lecture7Fig7}{fig:lecture7:lecture7Fig7}{0.2}
%
For a constant uniform magnetic field, we will be able to identify an intrinsic angular frequency
\begin{equation}\label{eqn:qmLecture7:140}
\omega_{\textrm{c}} = \frac{e B}{m}.
\end{equation}
To do so, we work with what is now called the Landau gauge
%
\begin{equation}\label{eqn:qmLecture7:60}
\BA = \lr{ 0, B x, 0 }.
\end{equation}
%
The curl of such a vector potential yields a uniform constant magnetic field
%
...
\imageFigure{../figures/phy1520-quantum/lecture7Fig8}{Energy levels, and Energy vs flux.}{fig:lecture7:lecture7Fig8}{0.1}

\index{degeneracy}
This is an infinitely degenerate system with an infinite number of states for any given energy level.  This tells us that there is a problem, and have to reconsider the assumption that any \( k_y \) is acceptable.
...
\imageFigure{../figures/phy1520-quantum/lecture7Fig9}{Landau degeneracy region.}{fig:lecture7:lecture7Fig9}{0.1}
...
%\imageFigure{../figures/phy1520-quantum/lecture7Fig10}{CAPTION: lecture7Fig10}{fig:lecture7:lecture7Fig10}{0.2}
...
%\imageFigure{../figures/phy1520-quantum/lecture7Fig11}{CAPTION: lecture7Fig11}{fig:lecture7:lecture7Fig11}{0.2}
