...
This leads to
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:20}
H =
\begin{bmatrix}
c \hatp & m(x) c^2 \\
m(x) c^2 & -c \hatp
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:40}
\sigma_y
=
\PauliY,
\end{equation}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:60}
\Phi(x) =
\begin{bmatrix}
f(x) \\
- i f(x)
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:80}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:100}
\begin{aligned}
...
\end{equation}
%
Now consider the matrix element of this commutator with respect to a position basis wavefunction \( \bra{x} \antisymmetric{H}{\hatcalP_{\textrm{Dirac}}} \ket{\Psi} \).  To compute this we must first understand the behavior of the anticommutators of scalar operators \( m, \hatp \) with \( \pi \).  That is
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:120}
\begin{aligned}
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:140}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:180}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:380}
\begin{aligned}
\lambda \Phi
&= H \Phi
\\ &=
...
\end{equation}
or
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:200}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:220}
\PD{x}{f} = - \inv{c \Hbar} m(x) c^2 f,
\end{equation}
%
which integrates to
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:240}
\ln f
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:260}
f(x) = f(0) \exp\lr{ - \int_0^x \frac{c}{\Hbar} m(x) dx }.
\end{equation}
%
For \( x > 0 \) this is
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:280}
\begin{aligned}
f(x)
...
%
and for \( x < 0 \) this is
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:300}
\begin{aligned}
f(x)
&= f(0) \exp\lr{ \int_0^x \frac{c}{\Hbar} m_0 dx }
\\ &= f(0) \exp\lr{ \frac{m_0 c x}{\Hbar}}.
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:320}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:340}
\begin{aligned}
1
&=
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet4Problem2:360}
