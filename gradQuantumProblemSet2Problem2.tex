...
\makeoproblem{Virial theorem.}{gradQuantum:problemSet2:2}{2015 ps2.2}{
\index{virial theorem}

Consider a three-dimensional Hamiltonian
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:21}
H = \frac{\Bp^2}{2m} + V(\Bx).
\end{equation}
%
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:41}
...
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:40}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:60}
\begin{aligned}
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:80}
\antisymmetric{ p_r}{ V(\Bx)}
= -i \Hbar \PD{x_r}{V(\Bx)},
\end{equation}
%
so
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:100}
\begin{aligned}
\ddt{}\lr{\Bx \cdot \Bp}
&=
\inv{i \Hbar}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:120}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:140}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:240}
\begin{aligned}
...
Note that
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:480}
\begin{aligned}
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:500}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:540}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:600}
\begin{aligned}
\expectation{ \Bx \cdot \spacegrad V }
&=
m \omega^2 \expectation{ \Bx^2(t) }
...
\end{equation}
%
%\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:260}
%\begin{aligned}
%\expectation{ \Bx \cdot \spacegrad V }
%&=
%%m \omega^2 \expectation{ \Bx^2(t) } \\
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:620}
\lr{ a_k e^{-i \omega t} + a_k^\dagger e^{i \omega t} } \lr{ \ket{0,0,0} + \ket{0,0,2} }.
\end{equation}
%
For \( k = 1 \) this is
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:640}
\ket{1,0,0} + \ket{1,0,2},
\end{equation}
%
for \( k = 2 \) this is
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:660}
\ket{0,1,0} + \ket{0,1,2},
\end{equation}
%
and for \( k = 3 \)
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:680}
\begin{aligned}
...
This gives
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:700}
\begin{aligned}
\expectation{ \Bx \cdot \spacegrad V }
&=
\frac{\Hbar\omega}{2}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:360}
\expectation{\frac{\Bp^2}{m}}
=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:380}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:400}
\begin{aligned}
\lr{ a_x^\dagger e^{i\omega t} - a_x e^{-i\omega t} } &\lr{ \ket{0,0,0} + \ket{0,0,2} } \\
&= 
e^{i\omega t}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:420}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:440}
\begin{aligned}
\expectation{\frac{\Bp^2}{m}}
&=
...
%%%or when
%%%
%%%\begin{equation}\label{eqn:gradQuantumProblemSet2Problem2:180}
