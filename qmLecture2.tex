...
%
\begin{equation}\label{eqn:qmLecture2:20}
...
%
\begin{equation}\label{eqn:qmLecture2:40}
\bra{x'} \hatA \ket{x} \leftrightarrow A_{x x'}
\end{equation}

The Hermitian property of the observable means that \( A_{x x'} = A_{x' x}^\conj \)
%
\begin{equation}\label{eqn:qmLecture2:60}
\begin{aligned}
\int dx \bra{x'} \hatA \ket{x} \braket{x }{\psi} 
&= \braket{x'}{\phi}
\\ &\leftrightarrow A_{x' x} \psi_x
\\ &= \phi_{x'}.
\end{aligned}
\end{equation}
%
...
%
\begin{equation}\label{eqn:qmLecture2:80}
...
%
\begin{equation}\label{eqn:qmLecture2:220}
\ket{\Psi}
=
...
%
\begin{equation}\label{eqn:qmLecture2:240}
...
%
\begin{equation}\label{eqn:qmLecture2:300}
\hat\rho = \ket{\Psi} \bra{\Psi}.
\end{equation}
%
This is \textAndIndex{idempotent}
%
\begin{equation}\label{eqn:qmLecture2:320}
\begin{aligned}
\hat\rho^2 &=
\lr{ \ket{\Psi} \bra{\Psi} }
\lr{ \ket{\Psi} \bra{\Psi} }
