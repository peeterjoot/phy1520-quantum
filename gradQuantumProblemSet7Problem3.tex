...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:40}
\begin{aligned}
\psi'(x)
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:60}
\begin{aligned}
\psi''(x)
&=
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:100}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:120}
\psi''(x)
=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:140}
\begin{aligned}
\braket{\psi}{\psi}
&=
...
Observe that
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:160}
\begin{aligned}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:200}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:220}
\begin{aligned}
...
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:240}
\begin{aligned}
\overbar{E}(\beta)
&=
...
Minimizing gives
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:260}
\begin{aligned}
0
&=
\frac{d}{d\beta}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet7Problem3:320}
\begin{aligned}
