...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:100}
V =
\left\{
\begin{array}{l l}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:180}
\begin{aligned}
H \psi
...
so that
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:320}
\begin{aligned}
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:220}
E =
\frac{-\Hbar^2}{2 m} \lr{
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:360}
E' \rho^2 =
\frac{-\Hbar^2}{2 m} \lr{
...
or
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:460}
0 =
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:500}
0 =
\begin{bmatrix}
J_{\pm \nu}( k \rho_a ) & N_\nu( k \rho_b ) \\
J_{\pm \nu}( k \rho_b ) & N_\nu( k \rho_b )
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:600}
\BA =
\left\{
\begin{array}{l l}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:620}
\begin{aligned}
\spacegrad \cross \BA
&=
...
and for \( \rho < \rho_a \)
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:640}
\begin{aligned}
\spacegrad \cross \BA
&=
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:660}
\begin{aligned}
H
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:680}
\begin{aligned}
...
and
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:700}
\begin{aligned}
...
so we have
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:720}
...
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:740}
\begin{aligned}
H \psi &=
E \psi \\ &=
\frac{-\Hbar^2}{2 m} \lr{
...
and are left with
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:780}
E' \rho^2 =
\frac{-\Hbar^2}{2 m} \lr{
\frac{\rho}{P} \partial_\rho \lr{ \rho \partial_\rho P } + \inv{\Phi} \partial_{\phi\phi} \Phi
}
...
Now set
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:800}
...
With \( \Phi = e^{i \nu \phi} \), that gives
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:820}
\begin{aligned}
E_\phi
&=
...
We are left with
%
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:840}
\begin{aligned}
E' \rho^2
&=
\frac{-\Hbar^2}{2 m} \lr{
...
%
or
\begin{equation}\label{eqn:gradQuantumProblemSet3Problem3:860}
\rho^2 P'' + \rho P +
