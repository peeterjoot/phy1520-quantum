...
%
\begin{equation}\label{eqn:ensemblesForSpinOneHalf:400}
\rho =
\begin{bmatrix}
a & b \\
c & d
...
%
\begin{equation}\label{eqn:ensemblesForSpinOneHalf:460}
\rho = w_{+} \ket{+}\bra{+} + w_{-} \ket{-}\bra{-},
\end{equation}
%
we must have
%
\begin{equation}\label{eqn:ensemblesForSpinOneHalf:480}
