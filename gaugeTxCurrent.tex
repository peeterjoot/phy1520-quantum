...
%
\makeoproblem{Gauge transformed current.}{problem:gaugeTxCurrent:1}{\citep{sakurai2014modern} pr. 2.37 (b)}{
...
&\quad\psi \lr{ \inv{2m} \BPi^\conj \cdot \BPi^\conj \psi^\conj + e \phi \psi^\conj } \\
&=
\inv{2m} \lr{
...
%
\begin{equation}\label{eqn:gaugeTxCurrent:240}
\spacegrad \psi = e^{i S/\Hbar} \spacegrad \sqrt{\rho} + \sqrt{\rho} e^{i S/\Hbar} \spacegrad \lr{ i S/\Hbar },
\end{equation}
%
so
\begin{equation}\label{eqn:gaugeTxCurrent:260}
\psi^\conj \spacegrad \psi
=
...
%
\begin{equation}\label{eqn:gaugeTxCurrent:280}
\Bj
...
Finally, note that
%
\begin{equation}\label{eqn:gaugeTxCurrent:320}
-i \Hbar \spacegrad \psi = \bra{ \Bx } \Bp \ket{\psi},
\end{equation}
%
so
%
\begin{equation}\label{eqn:gaugeTxCurrent:340}
\Bj
...
%
\begin{equation}\label{eqn:gaugeTxCurrent:360}
\begin{aligned}
\int d^3 x \Bj
&=
